...
description: "A production-oriented architecture pattern for long-running AI jobs using Azure Service Bus, Azure Container Apps, Cosmos DB, Redis, WebSockets, and REST hydration."
...
- **status updates**, such as `summary_updated`, `analysis_updated`, `research_updated`, and `composition_updated`;
- **step progress updates**, such as `analysis_step_progress`, `research_step_progress`, and `composition_step_progress`.
